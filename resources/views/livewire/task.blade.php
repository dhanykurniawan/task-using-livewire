            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        ...
                        <button wire:click="delete({{ $item->id }})" wire:confirm="Apa Anda yakin ingin menghapus task {{ $item->title }}?" class="btn btn-sm btn-outline-danger">Hapus</button>
                    </div>
                    @else
                    <div class="d-flex justify-content-center gap-2">
                        <p class="text-success mb-o fw-bold">Completed</p>
                        <button wire:click="delete({{ $item->id }})" wire:confirm="Apa Anda yakin ingin menghapus task {{ $item->title }}?" class="btn btn-sm btn-outline-danger">Hapus</button>
                    </div>
                    @endif
                </div>
